...
const Sidebar = ({ isCollapsed, onMouseEnter, onMouseLeave }) => {
  ...
  return (
    ...
    >
      <div
        className={`p-6 text-xl font-bold border-b border-gray-700 flex items-center gap-2 ${isCollapsed ? "justify-center" : ""}`}
      >
      ...
      <div className="p-4 border-t border-gray-700">
        <button
          ...
          className={`flex items-center w-full text-left hover:bg-gray-800 p-3 rounded-lg transition-colors ${isCollapsed ? "justify-center" : ""}`}
          title="Logout"
        >
                  ...
                  {currentUsers.length === 0 ? (
                    ...
                    currentUsers.map((u) => (
                      ...
                      >
                        ...
                        <td className="p-3 font-medium text-center text-gray-700 dark:text-gray-300">
                          {ordersCountByUser[u.id] || 0}
                        </td>
