...
//               className="font-semibold text-gray-800 hover:text-red-500 transition duration-200"
//             >
//               {data.name}
//             </button>
//           ))}
...
//               className="px-3 sm:px-4 py-2 border rounded-full w-36 sm:w-48 focus:outline-none focus:ring-2 focus:ring-red-300"
//             />
//           </div> */}
